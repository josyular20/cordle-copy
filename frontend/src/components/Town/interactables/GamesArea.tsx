...
import CordleArea from './Cordle/CordleArea';
    ...
    <>
      ...
      <Flex>
        <Box>
          ...
          ) : gameAreaController.toInteractableAreaModel().type === 'CordleArea' ? (
            <CordleArea interactableID={interactableID} />
          ) : (
        ...
        <Box
          ...
          <div
            ...
            <div style={{ marginTop: '20px' }}> {`Current Observers: ${observers.length}`}</div>
          </div>
        </Box>
      </Flex>
    </>
