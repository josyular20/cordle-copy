...
import CordleAreaController from './interactable/CordleAreaController';
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      this._socket.on('initialize', initialData => {
        ...
        initialData.interactables.forEach(eachInteractable => {
          ...
          } else if (isCordleArea(eachInteractable)) {
            this._interactableControllers.push(
              new CordleAreaController(eachInteractable.id, eachInteractable, this),
            );
          }
        });
